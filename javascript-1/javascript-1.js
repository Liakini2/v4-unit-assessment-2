...
//         if(i.inPerson === true || i.homework === true){
//             i.inPerson === false
//             i.homework === false
//         }
//     }
...
for(let i=0; i<lettersToPair.length; i++){
    for(let k=lettersToPair.length-1; k>i; k--){
...
//CODE HERE
  let phone1 = new Phone ('iphone', 'pro1', 1, 'gold', false)
  
  let phone2 = new Phone ('iphone', 'pro2', 1, 'green', false)
  
  let phone3 = new Phone ('iphone', 'pro3', 1, 'yellow', false)
